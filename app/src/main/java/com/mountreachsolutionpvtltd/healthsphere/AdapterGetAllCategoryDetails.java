...
public class AdapterGetAllCategoryDetails extends BaseAdapter {
    ...
    public AdapterGetAllCategoryDetails(List<POJOGetAllCategoryDetails> pogoGetAllCategoryDetails, Activity activity) {
        this.pojoGetAllCategoryDetails = pogoGetAllCategoryDetails;
